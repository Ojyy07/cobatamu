...
';
    ...
    $content .= '
<page>
    <h2 style="text-align:center;">Laporan Tamu Cluster Garnet <br> Tanggal '.tglIndonesia2(date('d F Y', strtotime($tgl1))).' s/d '.tglIndonesia2(date('d F Y', strtotime($tgl2))).'</h2>
    <br>';
