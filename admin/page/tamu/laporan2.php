...
';
    $content .= '
<page>
    <h2 style="text-align:center;">Laporan Tamu Cluster Garnet</h2>
    <br>';
    ...
    <table border="1px" class="tabel" align="center">
    		...
    		<tr>
				...
				$sql = $koneksi->query("select * from tb_tamu where id_unit_kerja='$unit_kerja' and tanggal between '$tgl1' and '$tgl2'  ");
