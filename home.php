...
<div class="box-tamu">
    <div class="row">
        ...
        <div class="margin-min5">
            ...
            <div class="pd-lr-5">
            <div class="form-group">
                <input type="text" name="instansi"  class="form-control" placeholder="Jenis kendaraan"  required="">
            </div>
            </div>
            </div>   
            <div class="column-2">
            ...
            <div class="pd-lr-5">
            <div class="form-group">
                <input type="text" name="telp"  class="form-control" placeholder="No Polisi"  required="">
            </div>
            </div>
            </div>
            ...
            <div class="pd-lr-5">
                <div class="form-group">
                    ...
                    <select class="form-control select2"  name="pegawai"  required="">
                        ...
                        <option value=""> Alamat Tujuan   </option>
                      <?php
